...
/**
 * Dialog for reporting listings with various reasons
 */
public class ReportListingDialog {
    ...
    public ReportListingDialog(Context context, Long listingId, String listingTitle, Long reporterId) {
    ...
    public void show() {
        ...
        View dialogView = LayoutInflater.from(context).inflate(R.layout.dialog_report_listing, null);
        ...
        ReportReason[] reasons = ReportReason.getListingReportReasons();
        ...
        AlertDialog dialog = new AlertDialog.Builder(context)
                ...
                .setMessage("Tin đăng: " + (listingTitle != null ? listingTitle : ""))
                .setView(dialogView)
    ...
    private void submitReport(String reason, String description) {
        Call<ApiResponse> call = apiService.reportListing(listingId, reporterId, reason, description);
